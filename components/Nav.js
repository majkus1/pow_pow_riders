			...
			<header
				...
				<nav ref={navRef}>
					<div
						...
						{isDropdownVisible && (
							<div className='dropdown-content'>
								<Link href='/kursy-indywidualne-snowboard.html' onClick={showNavbars}>
									Kursy indywidualne
								</Link>
								<Link href='/kursy-grupowe-snowboard.html' onClick={showNavbars}>
									Kursy grupowe
								</Link>
								<Link href='/zostan-instruktorem-snowboardu.html' onClick={showNavbars}>
									Szkolenia SITS
								</Link>
							</div>
						)}
					...
					<div
						...
						{isDropdownVisible2 && (
							<div className='dropdown-content'>
								<Link href='/pow-store/' onClick={showNavbars}>
									pow store
								</Link>
								<Link href='/pow-store/moje-konto/' onClick={showNavbars}>
									moje konto
								</Link>
								<Link href='/pow-store/koszyk/' onClick={showNavbars}>
									koszyk
								</Link>
								<Link href='/pow-store/privacy-policy/' onClick={showNavbars}>
									informacje
								</Link>
								<Link href='/pow-store/rodo-_powpowriders_/' onClick={showNavbars}>
									rodo
								</Link>
							</div>
						)}
					...
					<div
						...
						{isDropdownVisible3 && (
							<div className='dropdown-content'>
								<Link href='https://page.co/5w8tf' onClick={showNavbars}>
									Warsztaty treningowo-rozwojowe
								</Link>
								<Link href='/#blog' onClick={showNavbars}>
									Blog ridera
								</Link>
								<Link href='/instagram-pow-pow-riders.html' onClick={showNavbars}>
									instagram for riders only
								</Link>
							</div>
						)}
					</div>
					<Link href='/kontakt.html' onClick={showNavbars} className='two'>
						Kontakt
					</Link>
					<div onClick={showNavbars} className='panel-mob'>
				...
				<button className='nav-btn' onClick={showNavbars} aria-label='menu'>
