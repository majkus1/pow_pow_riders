	...
	return (
		<>
			<Head>
				...
				<meta
					name='description'
					content='Stań się częścią profesjonalnej społeczności instruktorów i trenerów snowboardu w Polsce. Odkryj III Stopień SITS w PPR.'
				/>
				<link rel='canonical' href='https://www.powpowriders.com/III-stopien-sits.html' />
			</Head>
			<Nav />
									...
									{sectionIndex2 === 1 && (
										<div className='description-programms'>
											<p className='description-programms-txt'>
												...
												posiadająca uprawnienia Instruktora MENiS. Absolwent tego kursu uzyskuje możliwość przystąpienia
												do kursu na stopień Instruktora SITS.
											</p>
