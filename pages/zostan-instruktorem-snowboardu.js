...
const Sits = () => {
	...
	const [buttonText, setButtonText] = useState('Sprawdź szczegóły')
	...
	const reviews = [
		...
		},
		{
			...
			author: 'opinia Filipa do roli Asystenta Instruktora SITS',
			words: 'WSPÓŁ',
			words2: 'PRACA',
			image: null, // brak obrazu
		},
	...
	return (
		<>
			<Head>
				<title>Pow Pow Riders | Zostań instruktorem snowboardu</title>
				<meta
					name='description'
					content='Zostań certyfikowanym instruktorem snowboardu z Pow Pow Riders! Oferujemy szkolenia II i III stopnia SITS oraz kurs Asystenta Instruktora. Rozwijaj się z nami!'
				/>
			</Head>
			<Nav />
				...
				<div className='page-container'>
					...
					<section className='become-instructor'>
						<div className='sits-head'>
							<h1>Zostań instruktorem snowboardu</h1>
							<h2>
								Szkolenia SITS{' '}
								<span>
						...
						<div className='buttons-to-open-info'>
							<div className='buttons-box'>
								...
								<div className='show-details'>
									<button onClick={() => handleButtonClick(1)} className='show-details-btn'>
										{visibleBlock === 1 ? 'Ukryj szczegóły' : '  Sprawdź szczegóły'}
										<AiFillCaretDown
											style={{ marginLeft: '5px', transform: visibleBlock === 1 ? 'rotate(180deg)' : 'none' }}
										/>
									</button>
								</div>
							</div>
							<div className='buttons-box'>
								...
								<div className='show-details'>
									<button onClick={() => handleButtonClick(2)} className='show-details-btn'>
										{visibleBlock === 2 ? 'Ukryj szczegóły' : 'Sprawdź szczegóły'}
										<AiFillCaretDown
											style={{ marginLeft: '5px', transform: visibleBlock === 2 ? 'rotate(180deg)' : 'none' }}
										/>
									</button>
								</div>
							</div>
							<div className='buttons-box'>
								...
								<div className='show-details'>
									<button onClick={() => handleButtonClick(3)} className='show-details-btn'>
										{visibleBlock === 3 ? 'Ukryj szczegóły' : 'Sprawdź szczegóły'}
										<AiFillCaretDown
											style={{ marginLeft: '5px', transform: visibleBlock === 3 ? 'rotate(180deg)' : 'none' }}
										/>
									</button>
								</div>
							</div>
						...
						<div className='show-details-mob'>
							<button onClick={() => handleButtonClick(1)} className='show-details-btn-mob'>
								{visibleBlock === 1 ? 'Ukryj szczegóły' : '  Sprawdź szczegóły'}
								<AiFillCaretDown
									style={{ marginLeft: '5px', transform: visibleBlock === 1 ? 'rotate(180deg)' : 'none' }}
								/>
										...
										{sectionIndex === 1 && (
											<div className='description-programms'>
												<p className='description-programms-txt'>
													<strong>II stopień sprawności SITS</strong> – kurs przeznaczony dla osób średniozaawansowanych
													i zaawansowanych. Jego uzyskanie jest potwierdzeniem umiejętności technicznych w zakresie
													...
													<br></br>
													<strong>Egzamin weryfikacyjny na II stopień sprawności SITS</strong> – mogą do niego
													przystąpić osoby, które w toku indywidualnego zdobywania umiejętności, chcą potwierdzić swój
													poziom jazdy. Egzamin przeznaczony dla osób średniozaawansowanych i zaawansowanych. Jego
													uzyskanie jest potwierdzeniem umiejętności technicznych w zakresie podstawowych i
													średniozaawansowanych ewolucji snowboardowych. Daje możliwość przystąpienia do kursu na III
													stopień sprawności oraz do kursu Asystenta Instruktora SITS.
												</p>
						...
						<div className='show-details-mob'>
							<button onClick={() => handleButtonClick(2)} className='show-details-btn-mob'>
								{visibleBlock === 2 ? 'Ukryj szczegóły' : 'Sprawdź szczegóły'}
								<AiFillCaretDown
									style={{ marginLeft: '5px', transform: visibleBlock === 2 ? 'rotate(180deg)' : 'none' }}
								/>
								...
								<div className='all-blocks'>
									...
									<div className='blocks-content'>
										{sectionIndex2 === 0 && (
											<>
												...
												<div className='details-info'>
													...
													<div className='reservation'>
														<Link
															href='https://powpowriders.com/pow-store/produkt/sits-kurs-iii-stopien-sits/'
															className='link-to-shop'>
															<GiPlayButton className='checks' style={{ marginRight: 5 }} />
															Zapisuję się
														</Link>
										...
										{sectionIndex2 === 1 && (
											<div className='description-programms'>
												<p className='description-programms-txt'>
													<strong>III stopień sprawności SITS</strong> – kurs przeznaczony dla osób zaawansowanych. Jego
													uzyskanie jest potwierdzeniem umiejętności technicznych w zakresie podstawowych,
													średniozaawansowanych i zaawansowanych ewolucji snowboardowych. Do kursu może przystąpić osoba
													posiadająca uprawnienia Instruktora MENiS. Absolwent tego kursu uzyskuje możliwość
												...
												<div className='plan-course'>
													...
													<img
														...
														onClick={() => handleImageClick4('/img/table-IIIST.webp')}
														className='img-plan-course'
														alt='tabelka ze szczegółami każdego dnia kursu'
													/>
												</div>
						...
						<h2 className='name-programm-mob'>Asystent Instruktora<span> SITS</span></h2>
						<div className='show-details-mob'>
							<button onClick={() => handleButtonClick(3)} className='show-details-btn-mob'>
								{visibleBlock === 3 ? 'Ukryj szczegóły' : 'Sprawdź szczegóły'}
								<AiFillCaretDown
									style={{ marginLeft: '5px', transform: visibleBlock === 3 ? 'rotate(180deg)' : 'none' }}
								/>
										...
										{sectionIndex3 === 1 && (
											<div className='description-programms'>
												<p className='description-programms-txt'>
													...
													lekcyjnych na poziomie II stopnia SITS);<br></br>– prezentuje umiejętności jazdy na
													snowboardzie zgodnie z realizowanymi w Polsce programami nauczania n poziomie II stopnia SITS;
													...
													<br></br>– prowadzić własną działalność gospodarczą w zakresie nauczania i doskonalenia jazdy
													na snowboardzie na poziomie podstawowym,<br></br>– prowadzić animacje zimowe dla dzieci i
													młodzieży
													...
													którym mowa w art. 46–50, lub określone w rozdziale XIX, XXIII, z wyjątkiem art. 192 i art.
													193, rozdziale XXV i XXVI ustawy z dnia 6 czerwca 1997 r. – Kodeks karny (Dz. U. z 2016 r.
													poz. 1137, z późn. zm.);<br></br>
													<br></br>
